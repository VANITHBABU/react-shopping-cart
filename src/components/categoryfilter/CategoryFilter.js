    ...
    <div class="filters mobile-filters shadow-sm rounded bg-white mb-4 d-none d-block d-md-none">
        <div class="border-bottom">
            <a class="h6 font-weight-bold text-dark d-block m-0 p-3" data-toggle="collapse" href="#mobile-filters"
                role="button" aria-expanded="false" aria-controls="mobile-filters">Filter By <i
                    ...
                    <div id="collapsetwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                        <div class="filters-card-body card-shop-filters">
                            ...
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="osahan119">Rain Jackets <small
                            ...
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="osahan1133"> Sweatshirts <small
                ...
                <div id="collapsetwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordion">
                    <div class="filters-card-body card-shop-filters">
                        ...
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="osahan11r">Rain Jackets <small
                                    class="text-black-50">120</small></label>
                        </div>
                        <div class="custom-control custom-checkbox">
                        ...
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="osahan11p"> Sweatshirts <small
                                    class="text-black-50">32</small></label>
                        </div>
                        <div class="custom-control custom-checkbox">
...
<img src="/assets/images/offer-2.png"
    class="w-100 bg-white rounded overflow-hidden position-relative shadow-sm d-none d-sm-none d-md-block" alt="..." />
    </div>   
       </>
    )
}
